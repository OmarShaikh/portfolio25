...
export function Container(props) {
  const { children, ...customMeta } = props;
    ...
    type: 'article'
    twitterHandle: "https://twitter.com/OmarCoyer",
  ...
  return (
    <div className={`bg-white dark:bg-dark min-h-screen`}>
	    <Head>
            ...
            <meta property="og:site_name" content="Omar Shayk" />
...
If you've made it this far and completed this article, I'd love for you to reach out to me on [Twitter](https://twitter.com/OmarCoyer) and send me a link to your blog or website so I can see the Open Graph images at work!
